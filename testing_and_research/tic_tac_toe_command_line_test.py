...
if __name__ == "__main__":              
    ...
    print(" --- --- ---")
    print()
    print("To play the game, enter the number for the square of choise.")
    print()
    ...
    # Variables to keep track of numner of winning games.
    player_wins = 0
    computer_wins = 0
    ...
    while not exit_program:
        ...
        # If player is in turn.                
            ...
            while True:
                if X_to_move:
                    choise = input("X to move: ")
                else:
                    choise = input("O to move: ")                
                
                if choise in "012345678" and len(choise) == 1:
                    if game_state[int(choise)] == " ":
                        if X_to_move:
                            game_state[int(choise)] = "X"
                        else:
                            game_state[int(choise)] = "O"
                        print()
                        break
                    else:
                        print()
